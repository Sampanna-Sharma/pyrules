...
class TestRule(unittest.TestCase):
    ...
    def test_isMatched(self):
        ...
        self.assertEqual(self.r1.isMatched(['a','b']),True)
    ...
    def test_apply(self):
        ...
        self.assertEqual(self.r1.apply(['a','c']),{'b'})
        ...
        self.assertEqual(self.r2.apply(['b','a','d']),{'c'})
        self.assertRaises(ruleError, self.r1.apply,{'b'})
        self.assertRaises(ruleError, self.r1.apply,{'b','c'})

        self.assertEqual(self.r3.apply(['a']),{'b','c'})
        self.assertEqual(self.r3.apply(['a','d']),{'b','c'})
        self.assertRaises(ruleError, self.r3.apply,{'b','d'})
